...
smiData.RigidTransform(1).translation = [350 0 0];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(2).translation = [2.7962521187419043e-10 74.999999999940584 1.0893463908701051e-10];  % mm
smiData.RigidTransform(2).angle = 2.0943951023931944;  % rad
smiData.RigidTransform(2).axis = [0.57735026918962529 -0.57735026918962629 0.57735026918962573];
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(4).translation = [8.682274794826068e-11 3.638929271774248e-11 -2.1592866889670926e-10];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(5).translation = [-32.499999999999972 520 32.500000000000028];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(6).translation = [-32.499999999962299 394.42452951136153 -32.499999999982826];  % mm
smiData.RigidTransform(6).angle = 3.1415926535897931;  % rad
smiData.RigidTransform(6).axis = [2.7582103268031233e-16 0.70710678118654746 -0.70710678118654757];
...
smiData.PrismaticJoint(1).ID = '[Lk1-1:-:lk3-1]';
...
smiData.RevoluteJoint(1).Rz.Pos = 126.01763495880252;  % deg
smiData.RevoluteJoint(1).ID = '[lk3-1:-:lk4-1]';

smiData.RevoluteJoint(2).Rz.Pos = 91.637252216724804;  % deg
